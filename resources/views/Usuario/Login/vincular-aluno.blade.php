                    ...
                    <div class="card-body p-5">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-3 d-flex align-items-end">
                                        <button type="button" class="btn btn-custom-blue w-100" onclick="confirmarAluno()">
                                            Confirmar
                                        </button>
                                    </div>
                                </div>
                        ...
                        <form method="POST" action="{{ route('register.finalizar') }}" id="formVincular">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('register.voltar') }}" class="btn btn-secondary fw-bold px-4 py-2 rounded-3">
                                    Voltar
                                </a>
