...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <form method="GET" action="{{ route('secretaria.frequencias.index') }}" class="mb-5">
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="number" id="ano" name="ano" placeholder="Ex: 2025" 
                           ...
                           value="{{ request('ano', date('Y')) }}" min="2020" max="2030">
                </div>
                <div class="col-md-3">
                    <label for="turma" class="form-label fw-medium">Turma</label>
                    <input type="text" id="turma" name="turma" placeholder="Ex: 1º A" 
                           class="form-control form-control-sm rounded-3 shadow-sm border" 
                           value="{{ request('turma') }}">
                </div>
                <div class="col-md-3">
            ...
            <div class="row mt-3">
                <div class="col-12">
                    ...
                    <a href="{{ route('secretaria.frequencias.index') }}" class="btn btn-secondary btn-sm">Limpar</a>
                </div>
            </div>
        </form>
            ...
            @empty
                <div class="row text-center py-4">
                    <div class="col-12 text-muted">
                        @if(request()->hasAny(['ano', 'turma', 'data_inicio', 'data_fim']))
