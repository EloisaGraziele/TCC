                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 border-2" style="border-color: #55B4F8;">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Acesso ao painel da secretaria</p>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 border-2" style="border-color: #55B4F8;">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Gerenciar responsáveis cadastrados</p>
                                        <button class="btn btn-primary" style="background-color: #55B4F8;">
                                            Gerenciar
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 border-2" style="border-color: #55B4F8;">
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-custom-blue fw-bold">Sistema</h5>
                                        <p class="card-text">Configurações gerais do sistema</p>
                                        <button class="btn btn-primary" style="background-color: #55B4F8;">
                                            Configurar
                                        </button>
                                    </div>
